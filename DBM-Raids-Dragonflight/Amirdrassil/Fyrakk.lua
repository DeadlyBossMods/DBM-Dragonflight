...
local warnEternalFirestormSwirl						= mod:NewCountAnnounce(402736, 3)
...
local timerEternalFirestormCD						= mod:NewCDCountTimer(41, 422935, 80066, nil, nil, 3, nil, DBM_COMMON_L.HEALER_ICON) --Short name "Tornado"
local timerEternalFirestormSwirlCD					= mod:NewCDCountTimer(41, 402736, nil, nil, nil, 3)
